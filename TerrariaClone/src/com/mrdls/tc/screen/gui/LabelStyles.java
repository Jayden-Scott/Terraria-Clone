...
public class LabelStyles {
	...
	public static LabelStyle button = new LabelStyle().setColor(Color.black).setBgcolor(Color.lightGray).setBorderWidth(2).setBorderColor(Color.darkGray).setMobgColor(Color.blue);
}
